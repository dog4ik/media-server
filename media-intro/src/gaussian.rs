...
#[cfg(test)]
mod tests {
    use crate::gaussian::{ReflectIterator, box_filter};
    ...
    fn width1() {
        ...
        assert_eq!(2.0, output[1]);
        assert_eq!(4.0, output[2]);
    }
    ...
    fn width2() {
        ...
        assert_eq!(input.len(), output.len());
        assert_eq!(1.0, output[0]);
        assert_eq!(1.5, output[1]);
        assert_eq!(3.0, output[2]);
    }
    ...
    fn width3() {
        ...
        assert_eq!(2.3333333333333333, output[1]);
        assert_eq!(3.3333333333333333, output[2]);
    }
    ...
    fn width5() {
        ...
        assert_eq!(2.4, output[1]);
        assert_eq!(2.6, output[2]);
    }
}
